...
export const signup = (signupcred: signupProp) => async (dispatch: Function) => {
    // dispatch({ type: USER_SIGNUP_LOADING })
    try {
        let res: AxiosResponse = await axios.post("https://clockify-clone-app.herokuapp.com/users/signup", signupcred)
