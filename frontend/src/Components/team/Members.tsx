    ...
    return (
      <Box>
        ...
        <Flex
          ...
          bg="white"
        >
          <Box width={"20%"} padding="10px 10px 10px 20px">
            NAME
          </Box>
          <Box width={"18%"} padding="10px 0px">
            EMAIL
          </Box>
          <Box width={"20%"} padding="10px 0px">
            BILLABLE RATE (USD)
          </Box>
          <Box width={"19%"} padding="10px 0px">
            ROLE
          </Box>
          <Box width={"20%"} padding="10px 0px">
            GROUP
        ...
        >
          ...
          <Box width={"20%"} padding="10px 0px">
            <Box>
              <Button backgroundColor="#03a9f4" color="white" variant="outline">
                Owner
              </Button>
            </Box>
          </Box>
